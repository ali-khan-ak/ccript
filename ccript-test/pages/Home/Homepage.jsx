...
const Main = () => {
    ...
    return (
        <>
            ...
            <div id='home' className='w-full h-screen text-center bg-cover mb-7 '>
            ...
            <footer class="bg-[#1867ce]">
                <div class="mx-auto w-full max-w-screen-xl">
                    <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                        <div>
                            <h2 class="mb-6 text-sm font-semibold text-[#ffffff] uppercase ">Company</h2>
                            <ul class="text-[#ffffff] font-medium">
                                <li class="mb-4">
                        ...
                        <div>
                            <h2 class="mb-6 text-sm font-semibold text-[#ffffff] uppercase dark:text-white">Help center</h2>
                    ...
                    <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                        <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="https://flowbite.com/">Educationic-X™</a>. All Rights Reserved.
                        </span>
